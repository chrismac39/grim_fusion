...
class GuidePage(QWidget):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        _add_section(
            ...
            "uses existing gdse-based colorization files when present and "
            "bundled English files for anything missing. The first export preserves an "
        ...
        _add_section(
            ...
            "- Character save import is officially supported for Grim Dawn 1.2.x+ "
            "saves; older saves are imported on a best-effort basis and may be "
            "partial.\n"
